...
public class _01_JavaLocalDate {
    public static void main(String[] args) {
        ...
        System.out.println("ISO_DATE="+ tarih.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT)));
        System.out.println("ISO_DATE="+ tarih.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)));
        System.out.println("ISO_DATE="+ tarih.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.LONG)));
        System.out.println("ISO_DATE="+ tarih.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)));

        System.out.println("\n**************");
        // Localde aldığım tarihi istediim ülkenin formatına göre, diline göre nasıl gösteririm?
        ...
        // en-US : birincisi DİLİ, ikincisi ükeyi temsil ediyor.
