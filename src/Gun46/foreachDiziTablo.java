...
public class foreachDiziTablo {
    public static void main(String[] args) {
        ...
        System.out.println("dizi1 = " + dizi1.length);   // dizinin eleman sayısı
        ...
        for (int eleman : dizi){ // içindeki elelmanları teker teker alarak eleman isimli değişkene atar
        ...
        System.out.println("tablo3.length = " + tablo3.length); // tablo3 satır sayısını vererek 2, tablonun elelmanları satırlardan oluşur
        ...
        for (int i = 0; i < tablo3.length; i++) {
            ...
            for (int j = 0; j < tablo3[0].length; j++) {  // önce tablo[0] 5, sonra tablo[1] 2
        ...
        {
            // 1.Adımsa satır 2 3 4 5 6 aşağıdaki döngü sadece 2.3 yazar
